...
main()
{
	...
	cout<<"\t\t\t\t\t*****\tRanjith's Laptop Store\t*****"<<endl<<endl;
	cout<<"\t\t\t\t\tWelcome To Ranjith's Laptop Repair Store."<<endl;
...
void give()
{
	...
	h:
	g:
	cout<<"What's the problem in the Laptop ? :\n";
...
void accs()
{
	...
	char x,y;
	string serial,model;
	cout<<"Please Input The Details of the Laptop :\nCompany :";
	cin.ignore();
	getline(cin,serial);
	cout<<"Model No:";
	cin.ignore();
